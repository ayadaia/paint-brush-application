	...
	public class DrawPanel extends JPanel {
	    ...
	    JCheckBox redCK, greenCK, blueCK;
	   ...
	   ArrayList <int[]> freehandlines = new ArrayList<>();
	    ...
	    DrawPanel(){
	        ...
	        lineBtn.addActionListener(e->currentshape=new Line(0,0,0,0,isDotted,isFilled,currentColor));
	        this.add(lineBtn);
	        
	        rectBtn=new JButton("Rectangle");
	        rectBtn.addActionListener(e->currentshape=new Rectangle(0,0,0,0,isDotted,isFilled,currentColor));
	        this.add(rectBtn);
	        
	        ovalBtn=new JButton("Oval");
	        ovalBtn.addActionListener(e->currentshape=new Oval(0,0,0,0,isDotted,isFilled,currentColor));
	        this.add(ovalBtn);
	        
	        freehandBtn=new JButton("Pencil");
	        freehandBtn.addActionListener(e->currentshape=new FreeHand(0,0,0,0,isDotted,isFilled,currentColor));
	        this.add(freehandBtn);
	        
	        eraserBtn = new JButton("Eraser");
	        eraserBtn.addActionListener(e -> currentshape = new Eraser(0,0,0,0,isDotted,isFilled,currentColor));
	        this.add(eraserBtn);
	       ...
	       filledCK=new JCheckBox("Filled");
	       greenCK=new JCheckBox("Green");
	       blueCK=new JCheckBox("Blue");
	       redCK=new JCheckBox("Red");
	       
	       colorGroup.add(redCK);
	       colorGroup.add(greenCK);
	       colorGroup.add(blueCK);
	       ...
	       //action listener foe filled checkbox
	       filledCK.addActionListener(e -> {
	    	   isFilled= filledCK.isSelected();
	    	   isDotted=false;
	    	   isSolid = true;
	    	   repaint();
	       });
	    	
	       greenCK.addActionListener(e -> {
	       ...
	       blueCK.addActionListener(e -> {
	    	   
	    	   currentColor=Color.blue;
	    	   //repaint();
	       });
	       
	       redCK.addActionListener(e -> {currentColor=Color.red;
	    	   //repaint();
	       });
	    ...
	    public class MyMouseListener implements MouseListener{
	        ...
	        shapes.add(new Line(x1, y1, x2, y2,isDotted,isFilled,currentColor));
	    } else if (currentshape instanceof Rectangle) {
	        shapes.add(new Rectangle(x1, y1, x2, y2,isDotted,isFilled,currentColor));
	    } else if (currentshape instanceof Oval) {
	        shapes.add(new Oval(x1, y1, x2, y2,isDotted,isFilled,currentColor));
	    }
